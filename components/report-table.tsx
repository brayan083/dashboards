...
export const columns: ColumnDef<Payment>[] = [
  {
    accessorKey: "keyword",
    header: "Keyword",
    cell: ({ row }) => <div className="capitalize">{row.getValue("keyword")}</div>,
  },
  {
    accessorKey: "volume",
    header: "Search Volume",
    cell: ({ row }) => <div className="lowercase">{row.getValue("volume")}</div>,
  },
  {
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>View keyword details</DropdownMenuItem>
            <DropdownMenuItem>View competing pages</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      )
    },
